        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    sumMouse++;
                    Log.e("logssss", "index: " + index + "\tmouseCheckedId: " + mouseCheckedId
                            + "\tbtnAtrr[index]:" + btnAtrr[index] + "\tbgAtrr[index]:" + bgAtrr[index]);
                    if (mouseCheckedId == btnAtrr[temp]) {
                        Log.e("logssss", "pare: " + mouseCheckedId + ":" + btnAtrr[index]);
                        clickMouse++;  //判断当前老鼠所在的RadioButton的id与用户点击的是否一致，若一致则为打中地鼠
                    }
                    temp = index;
                    break;
                case 2:
                    times.setText(String.valueOf(t));
                    goals.setText(String.valueOf(clickMouse));
                    t--;
                    break;
            }
        }
...
//                    myHandler.sendMessage(message);
    ...
    private void initView() {
        ...
        ll_bg_show = findViewById(R.id.ll_bg_show);
